...
export function PixiMapCanvas({document,activeTool,selectedTileId,brushSize,selection,onPaint,onSelectionChange,onStamp,onObjectPlace,onObjectMove,selectedObjectId,terrainBindings={}}:Props){
  ...
  useEffect(()=>{
    ...
    void app.init({resizeTo:host,background:'#0f1318',antialias:true}).then(()=>{
      ...
      const world=new Container(),grid=new Graphics(),overlay=new Graphics();
