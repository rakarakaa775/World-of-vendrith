...
export const createMap=(mapType:MapType='playable',parentMapId:string|null=null):MapDocument=>({version:1,id:`${mapType}-map-${Date.now()}`,name:`${mapType[0].toUpperCase()+mapType.slice(1)} Map`,mapType,parentMapId,width:20,height:12,tileSize:32,layers:[layer('ground','Ground','ground',true),layer('objects','Objects','objects'),layer('collision','Collision','collision')]});
