...
export type MapObject = { id:string; kind:'building'|'decoration'|'poi'; category:string; x:number; y:number; width:number; height:number; assetId:string; rotation:number; zIndex:number; collision:boolean; interiorMapId?:string|null };
